    ...
    <div class="w-full max-w-[1200px]">
      <section class="mt-4 border-l-4 border-[var(--bc-blue)] bg-[var(--bc-surface-light)] px-6 pt-2 pb-4">
        ...
        <p class="mt-4 text-lg text-[var(--bc-text-secondary)]">
          Accelerate AI adoption with a secure, scalable, and government-managed platform designed to help ministries
          and program areas build AI-powered solutions faster.
        </p>
        <a
          href="#get-started"
      ...
      <section class="border-t border-[var(--bc-border)] py-4">
        ...
        <p class="mt-2 text-[var(--bc-text)]">
          The AI Common Service provides ministries and government teams with access to enterprise AI capabilities
          through a shared platform managed by the Economic Opportunities division within CSBC. Instead of building and
      ...
      <section class="border-t border-[var(--bc-border)] py-4">
        ...
        <ol class="mt-6 list-decimal space-y-2 pl-6 text-[var(--bc-text)]">
          ...
          <li>
            ...
            <br />
            AI services generate embeddings and make your content searchable using contextual and semantic
            understanding.
          </li>
          <li>
      ...
      >
        ...
        <p class="mt-6 text-[var(--bc-text)]">
          Whether you are evaluating an AI opportunity, building a proof of concept, or scaling an existing solution,
          the AI Common Service provides a secure foundation for government AI initiatives.
        </p>
        <a
          href="/contact"
