...
/>
    ...
    <!-- 2) Licence Season -->
    <Fieldset
legend="Licence Season"
class="mb-3"
>
        <div
class="flex gap-3 align-items-center"
role="group"
aria-label="Licence season selection"
>
            <div class="flex align-items-center gap-2">
                <RadioButton
v-model="form.season"
input-id="seasonCurrent"
name="season"
value="current"
/>
...
for="basicStartDate"
class="font-bold block mb-2"
>Start Date (1-day / 8-day)</label>
                <Calendar
id="basicStartDate"
v-model="form.basicStartDate"
date-format="yy-mm-dd"
:manual-input="true"
                    :show-icon="true"
class="w-full"
...
>
    ...
    <Fieldset
legend="Conservation Surcharges & Sturgeon"
class="mb-4"
>
...
>White Sturgeon Conservation
                    ...
                    <Select
id="sturgeonOpt"
v-model="form.sturgeonOpt"
:options="sturgeonOptions"
                        placeholder="— Not required —"
class="w-full"
/>
                </div>
                <div
v-if="showSturgeonStart"
...
/>
    ...
    <!-- 5) Classified Waters -->
    <Fieldset
legend="Classified Waters Licence"
class="mb-4"
>
...
for="cwRequired"
class="font-bold block mb-2"
>Will you fish Classified Waters?</label>
                <Select
id="cwRequired"
v-model="form.cwRequired"
...
/>
            ...
            <div class="col-12 md:col-6">
                <label
for="cwResidencyConfirm"
class="font-bold block mb-2"
>Residency (for CW rules)</label>
                <Select
id="cwResidencyConfirm"
v-model="form.cwResidencyConfirm"
:options="residencyOptions"
                    placeholder="— Select —"
class="w-full"
/>
...
for="cwWaterbody"
class="font-bold block mb-2"
>Waterbody / River <span
                            class="text-red-500"
>*</span></label>
                    <InputText
id="cwWaterbody"
v-model="form.cwWaterbody"
class="w-full"
/>
                </div>
                <div class="col-12 md:col-6 lg:col-4">
...
>Class (I / II)</label>
                    <Select
id="cwClass"
v-model="form.cwClass"
:options="cwClassOptions"
placeholder="— Select —"
                        class="w-full"
/>
                </div>
...
for="cwStart"
class="font-bold block mb-2"
>Start Date (Non-Residents per-diem)</label>
                    <Calendar
id="cwStart"
v-model="form.cwStart"
date-format="yy-mm-dd"
:manual-input="true"
                        :show-icon="true"
class="w-full"
...
for="cwDays"
class="font-bold block mb-2"
>Number of Days (Non-Residents)</label>
                    <InputText
id="cwDays"
v-model="form.cwDays"
inputmode="numeric"
...
/>
    ...
    <!-- 6) Declarations -->
    <Fieldset
legend="Declarations & Acknowledgements"
class="mb-4"
>
        <div class="flex flex-column gap-3">
            <div class="flex align-items-center gap-2">
                <Checkbox
v-model="form.ackAccuracy"
input-id="ackAccuracy"
:binary="true"
/>
                <label
for="ackAccuracy"
class="cursor-pointer"
>I certify the information provided is accurate and
                    complete.</label>
            </div>
            <div class="flex align-items-center gap-2">
                <Checkbox
v-model="form.ackRules"
input-id="ackRules"
:binary="true"
/>
                <label
for="ackRules"
class="cursor-pointer"
>I have reviewed the Freshwater Fishing Regulations and
