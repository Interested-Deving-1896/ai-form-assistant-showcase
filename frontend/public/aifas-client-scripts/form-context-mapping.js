...
window.formContextMapping = [
  {
    ...
    schema: {
      ...
      AnswerOnJob_housing: {
        fieldLabel:
          'Is this application in relation to increasing the supply of housing units within British Columbia?',
        options: [
          { key: 'yes', value: 'Yes' },
          { key: 'no', value: 'No' }
        ],
      ...
      'AnswerOnJob_bc-hydro-sustainability': {
        fieldLabel:
          'Is this application related to a BC Hydro Sustainment Project required for the maintenance and upgrading of existing electricity infrastructure, such as replacing aging equipment, improving transmission systems, or reinforcing substations to support long-term energy needs?',
        options: [
          { key: 'yes', value: 'Yes' },
          { key: 'no', value: 'No' }
        ],
      ...
      'AnswerOnJob_clean-energy': {
        fieldLabel:
          'Is this application related to a clean energy project that received a new Energy Purchase Agreement from BC Hydro between 2024-present?',
        options: [
          { key: 'yes', value: 'Yes' },
          { key: 'no', value: 'No' }
        ],
      ...
      EligibilityExplanation_100380943_185457063: {
        fieldContext:
          'For more information related to a clean energy project, please provide any relevant information.',
      ...
      V1IsEligibleForFeeExemption: {
        fieldLabel:
          "Do you belong to, are you applying on behalf of, or are you: a provincial government ministry, the Government of Canada, A First Nation for water use on reserve land, A person applying to use water on Treaty Lands,  A Nisga'a citizen or an entity applying to use water from the Nisga'a Water Reservation?",
        options: [
          { key: 'yes', value: 'Yes' },
          { key: 'no', value: 'No' }
        ],
      ...
      V1FeeExemptionCategory: {
        ...
        options: [
          ...
          {
            key: 'First Nations/Indian Band for use on Reserve',
            value: 'First Nations/Indian Band for use on Reserve'
          },
          {
            key: 'Acting on behalf of a BC provincial ministry with a letter of permission from that ministry',
            value: 'Acting on behalf of a BC provincial ministry with a letter of permission from that ministry'
          },
      ...
      V1FeeExemptionSupportingInfo: {
        fieldLabel:
          'Please enter any supporting information that will assist in determining your eligibility for a fee exemption. Please refer to help for details on fee exemption criteria and requirements. ',
        options: [
          { key: 'yes', value: 'Yes' },
          { key: 'no', value: 'No' }
        ],
